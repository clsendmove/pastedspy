...
public:
	...
	bool SendNetMsg(INetMessage& msg, bool bForceReliable = false, bool bVoice = false) {
		return U::Memory.GetVFUNC<bool(__thiscall*)(void*, INetMessage&, bool, bool)>(this, 37)(this, msg, bForceReliable, bVoice);
	}
	...
	bool CanPacket()
	{
		return U::Memory.GetVFUNC<bool(__thiscall*)(void*)>(this, 53)(this);
	}
