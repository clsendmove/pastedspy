...
public:
	...
	inline void SetHost(CBasePlayer* pHost)
	{
		...
		// vannie: SetHost is vfunc 12.. dont use a offset for this.
		typedef void(__thiscall* fn)(void*, CBasePlayer*);
		return U::Memory.GetVFUNC<fn>(this, 12)(this, pHost);
	}
